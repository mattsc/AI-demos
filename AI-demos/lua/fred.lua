...
--fred.data.turn_data = nil
            ...
            then
                fred.data.turn_data = FOU.set_turn_data(fred.data.gamedata)
                fred.data.ops_data = FOU.set_ops_data(fred.data, fred.recruit)
            else
                FOU:update_ops_data(fred.data)
            end



            FOU.get_action_cfgs(fred.data)
