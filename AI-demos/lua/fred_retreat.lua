...
local function get_healing_map()
...
local function find_best_retreat(retreaters, retreat_utilities, fred_data)
...
function fred_retreat.get_retreat_action(zone_cfg, fred_data)
    ...
    if next(retreaters) then
        ...
        local retreat_combo = find_best_retreat(retreaters, retreat_utilities, fred_data)
