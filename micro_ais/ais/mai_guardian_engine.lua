return {
	...
	--Used required params : id, zone_goals (SFL)
	--Used optionnal param : zone_enemy (SLF)

	-- The zone guardian will randomly move accross the specified zone_goals until it "detects" an enemy in the zone_enemy(if specified) or in the zone_goals 				(otherwise). It will then attack this enemy until it goes out of the "attack zone"
